...
(function () {
  ...
  /* 🆕 19/08 — CHE DO data-active="auto".
     Ly do: trang krpano `tour360\tour.html` phuc vu 2 muc menu (To&#224;n c&#7843;nh /
     Flycam hi&#7879;n tr&#7841;ng) tren CUNG 1 FILE, chi khac duoi ?startscene=.
     Khong the ghi cung data-active. => 'auto' tu do URL hien tai voi href
     trong ITEMS: uu tien khop tham so startscene, khong co thi khop duong dan.
     ⚠️ ADDITIVE — 5 trang cu van truyen id cu the, khong di qua nhanh nay. */
  if (active === 'auto') {
    var qs = new URLSearchParams(location.search);
    var scene = qs.get('startscene') || '';
    ...
    /* Khong doan ra thi de TRONG — tha khong to sang con hon to sang nham muc. */
    active = hit;
  }
